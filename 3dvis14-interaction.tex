...
\title{Touch vs 3D interaction in a medical environment}
...
\shortauthortitle{Sund\'en \MakeLowercase{\textit{et al.}}: Touch vs 3D interaction in a medical environment}
...
\keywords{interaction, touch display, tracking}
