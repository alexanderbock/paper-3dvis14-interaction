...
%% Abstract section.
\abstract{
Key argument: Interaction should not only be natural for the user, but also for the viewers. Thus, while some natural exploratory interaction methods fit well for the user, they may be less beneficial for the actual viewers, and vice versa.
