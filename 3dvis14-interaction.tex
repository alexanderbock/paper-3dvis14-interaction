...
%% Abstract section.
\abstract{
Key disucssion point: Interaction should not only be natural for the user, but also for the viewers. Thus, while some natural exploratory interaction methods fit well for the user, they may be less beneficial for the actual viewers, and vice versa.
...
We focus this paper on none expert users and viewers of the scientific data and of volume data exploration in general.
