...
Figure~\ref{classifiy_diagram} shows the relevance of the techniques in dependence of audience size and display size. 
...
Voice control is suitable in most variations of display and audience sizes, however, we reckon that this interaction should be used when no other technique is suitable, as it is less flexible in general.
